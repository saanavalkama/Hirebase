...
export const candidateProfileSchema = z.object({
    ...
    linkedInUrl: z.string().transform(v => v || undefined).optional().refine(val => !val || z.url().safeParse(val).success, "Invalid URL"),
    personalSiteUrl: z.string().transform(v => v || undefined).optional().refine(val => !val || z.url().safeParse(val).success, "Invalid URL"),
    cvUrl: z.string().transform(v => v || undefined).optional().refine(val => !val || z.url().safeParse(val).success, "Invalid URL"),
